...
# load test data (2 separate data frame to compare against each other)
a <- data.frame(name=c('Josh','John', 'Chad', 'Steve', 'Peter', '4031 Addie LN', '1750 Commerce Drive'))
b <- data.frame(name=c('Josh','John', 'Chad', 'Steve', 'Peter', 'osh', 'ohn', 'had', 'eve', 'reteP', '1750 Commerce Dr', '750 Commerce Dr'))
